      ...
      <div className="container mx-auto px-6 relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="text-white/70 max-w-3xl mx-auto" style={{ fontSize: "clamp(1rem, 2vw, 1.125rem)" }}>
           I’m a storyteller and designer driven by a passion for creating extraordinary experiences that go beyond traditional boundaries.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-32">
          ...
          >
            <div className="glass p-8 rounded-3xl h-full">
              <h3 className="mb-6" style={{ fontSize: "clamp(1.5rem, 4vw, 2rem)" }}>
                My Philosophy
              </h3>
              <p className="text-white/70 mb-6">
                Every destination has a soul. Every brand has a story. I believe in the power
                of immersive design to bridge the gap between aspiration and experience.
              </p>
              <p className="text-white/70 mb-6">
                Through cinematic visuals, thoughtful narratives, and cutting-edge technology,
                I craft digital experiences that don't just showcase — they transport.
              </p>
