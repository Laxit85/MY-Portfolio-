...
export function Projects() {
  ...
  return (
    <section id="projects" className="relative py-32 bg-gradient-to-b from-[#0a0a0f] to-[#050508]">
      <div className="container mx-auto px-6" ref={ref}>
        ...
        >
          <p className="text-[#00ffc8] mb-4 tracking-widest">PORTFOLIO</p>
          <h2
            className="mb-6"
            style={{
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-end">
                ...
                >
                  <span className="text-sm text-[#00ffc8]">{project.category}</span>
                </motion.div>

                <h3 className="mb-2" style={{ fontSize: "clamp(1.25rem, 3vw, 1.5rem)" }}>
                  {project.title}
                </h3>
                ...
                >
                  <ArrowUpRight size={20} className="text-[#00d4ff]" />
                </motion.div>
              </div>
